...
export default function CheckInCorrectionsPage() {
  ...
  return (
    <StaggerContainer className="flex flex-col gap-6 p-4 md:p-6">
      <StaggerItem>
        <StandardPageHeader
      ...
      <ConfirmDialog
        ...
        message={`Remove ${selectedIds.length} campus check-in(s)? Students can check in again via Terminal. Lesson attendance is not reverted.`}
