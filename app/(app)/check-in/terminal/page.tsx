...
import { AlertTriangle, Check, X, Loader2, Search, User as UserIcon } from "lucide-react"
...
import { QrScanner, type QrScannerHandle } from "@/components/check-in/qr-scanner"
...
export default function TerminalPage() {
  ...
  const scannerRef = React.useRef<QrScannerHandle>(null)
